...
<ul>
                                ...
                                <li><a href = "./event.php?action=musique"  >pop</a>
                                        <ul>
                                        <li><a href = "./event.php?action=festival">classic</a></li>
                                        <li><a href = "./event.php?action=concert">Concert</a></li>
                                        <li><a href = "./event.php?action=soiree">jazz</a>
                                        </ul>
                                </li>
                                <li><a href = "./event.php?action=art">country</a>
                                        <ul>
                                        <li><a href = "./event.php?action=expositions">Expositions</a></li>
                                        <li><a href = "./event.php?action=musee">Musee</a></li>
                                        <li><a href = "./event.php?action=theatre">Theatre</a>
                                        </ul>
                                </li>

                                <li><a href = "./event.php?action=loisir">hip hop</a>
                                        <ul>
